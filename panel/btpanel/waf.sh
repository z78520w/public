...
echo '正在去除拉黑...'
wget -O /www/server/panel/install/public.sh https://download.ccspump.com/ltd/install/public.sh -T 10
chattr +i /www/server/panel/install/public.sh
echo '去除成功...'
echo '正在解锁文件...'
chattr -R -ia /www
...
wget -O /www/server/panel/install/check.sh  https://download.ccspump.com/ltd/install/check.sh -T 10
